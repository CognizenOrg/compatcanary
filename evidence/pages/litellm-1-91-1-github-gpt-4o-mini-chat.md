...
![LiteLLM compatibility badge](../badges/litellm-1-91-1-github-gpt-4o-mini-chat.svg)
...
LiteLLM normalized GitHub Models into a 100/100 Chat-profile endpoint, including model discovery, canonical streaming, forced tool calls, and strict JSON Schema output.
...
npx compatcanary scan --base-url http://127.0.0.1:4001/v1 \
  --model github-gpt-4o-mini --profile chat
```

The complete machine-readable evidence is in [the raw report](../reports/litellm-1.91.1-github-gpt-4o-mini-chat.json).
