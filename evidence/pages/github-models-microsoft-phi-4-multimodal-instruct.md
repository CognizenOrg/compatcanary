...
![Microsoft compatibility badge](../badges/github-models-microsoft-phi-4-multimodal-instruct.svg)
...
| Chat streaming | yes | **PASS** | Received 14 valid chat stream chunks and [DONE] |
...
npx compatcanary scan --base-url https://models.github.ai/inference \
  --model microsoft/phi-4-multimodal-instruct --profile chat
```

The complete machine-readable evidence is in [the raw report](../reports/github-models-microsoft-phi-4-multimodal-instruct.json).
